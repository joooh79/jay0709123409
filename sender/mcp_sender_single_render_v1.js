  ...
  if (isPhase1ApplicableExistingVisitUpdate(args.payload)) {
    ...
    if (finalConfirmation !== 'send_now') {
      return {
        ...
        message: 'sender_send는 최종 확인 완료 후에만 실행됩니다. 먼저 sender_transform preview를 보고, 확인값(1/send_now)을 포함해 다시 호출해 주세요.',
        write_allowed: false,
        resend_allowed: false,
...
function runHealthTool() {
  return {
    ...
    version: '1.1.6-phase1-existing-visit-update-hotfix6',
